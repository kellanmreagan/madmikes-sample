...
<head>
  ...
  <title>Mad Mike's . Ohio Drag Racing, Building & Parts Fabrication</title>
  <meta name="description" content="Contact Mad Mike's today for a free rate quote. Northeast Ohio's destination for Drag Racing, custom Race Car building, Automotive restoration and repair, Motorcycle racing and repair, chassis building, parts fabrication">
  <meta name="keywords" content="email,contact us,contact us page,mad mikes motorsports,mike renner,strasburg,ohio,ohio auto repair,ohio drag racing,custom race car,funnycar,dragster,engine,motor,service,oh">
  ...
  <header class="site-header">
    ...
    <nav id="site-nav" class="site-nav">
      <ul>
        ...
        <li><a href="contact.php" title="Request a Quote" class="is-active">CONTACT US</a></li>
      </ul>
    </nav>
  </header>
  <main id="content" class="page">
    <div class="page-title">
      <h1>Call Today. No job too large or small!</h1>
    </div>
    <div class="layout">
    <aside class="rail">
