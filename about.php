...
<body class="">
  ...
  <header class="site-header">
    ...
    <nav id="site-nav" class="site-nav">
      <ul>
        ...
        <li><a href="about.php" title="About Mad Mike's Motorsports" class="is-active">ABOUT US</a></li>
  ...
  <main id="content" class="page">
    <div class="page-title">
      <h1>Quality Service at an Affordable Price</h1>
    </div>
    <div class="layout">
    <aside class="rail">
